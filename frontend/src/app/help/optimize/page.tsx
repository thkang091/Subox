  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="max-w-4xl mx-auto py-16 px-8 -mt-30">
        <h1 className="text-3xl font-bold text-orange-600 mb-2 text-left pl-4">Optimize listing</h1>
        <h1 className="text-md font-sans text-gray-600 mb-6 text-left pl-4">Learn how to get your badges.</h1>
        <h1 className="text-sm font-sans text-gray-400 text-left pl-4">{opData.length} articles</h1>
