...
export default function optimizePage({ params }: OPPageProps) {
  // State variables
  ...
  const opItem = opData.find((op) => op.id === Number(params.id));
    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-200 via-white to-white text-black">
      ...
      <div className="flex justify-center mt-10">
        ...
        <div className="max-w-3xl mx-auto py-16 px-6">
            <h1 className="text-3xl font-bold text-orange-600 mb-4">{opItem.question}</h1>
            <p className="text-lg text-gray-700">{opItem.answer}</p>
            <a
                href="/help/optimize"
                className="inline-block mt-8 px-6 py-2 bg-orange-500 text-white rounded hover:bg-orange-600"
            >
                ← Back to How to optimize my listing
            </a>
        </div>
