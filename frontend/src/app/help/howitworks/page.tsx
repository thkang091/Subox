...
export const hiwData: HIWItem[] = [
    {
      id: 1,
      question: "How do I create an account?",
      answer: "To create an account, click signup and fill the form."
    },
    {
      id: 2,
      question: "How do I post a listing?",
      answer: "After logging in, click 'Post' and fill details or use AI listing."
    },
    {
      id: 3,
      question: "How do I filter and save my pick in moving sales?",
      answer: "Click the icon on the bottom right and filter what you'r finding. Then, click the heart button by saving in your favorite list."
    },
    {
      id: 4,
      question: "How do I find a place to rent?",
      answer: "Go to the sublease page and filter through the map in it and check your preference like date, cleanliness, etc."
    }
];
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="max-w-4xl mx-auto py-16 px-8 -mt-30">
        <h1 className="text-3xl font-bold text-orange-600 mb-2 text-left pl-4">How it Works</h1>
        <h1 className="text-md font-sans text-gray-600 mb-6 text-left pl-4">Step-by-step guide on using the platform.</h1>
        <h1 className="text-sm font-sans text-gray-400 text-left pl-4">{hiwData.length} articles</h1>
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 my-7">
              <div className="space-y-4">
                {hiwData.map((hiw) => (
                  <Link key={hiw.id} href={`howitworks/${hiw.id}/`}>
                    <div className="cursor-pointer p-4 rounded hover:bg-orange-100 transition">
                      <h3 className="text-lg font-semibold text-orange-600">{hiw.question}</h3>
                    </div>
                  </Link>
                ))}
              </div>
