...
export const troubleData: TSTItem[] = [
  {
    id: 1,
    question: "I forgot my password.",
    answer: "Click 'Forgot password' to reset it."
  },
  {
    id: 2,
    question: "App crashes on launch.",
    answer: "Try refreshing the website or check your browser update, blocks, etc. and if it still doesn't work, contact us."
  },
  {
    id: 3,
    question: "Google and Facebook log in is not working.",
    answer: "Try refreshing the website or check your Google or Facebook account and if it still doesn't work, contact us.."
  },
  {
    id: 4,
    question: "Cannot go to the next page.",
    answer: "Check your network and if it still doesn't work, contact us."
  },
  {
    id: 5,
    question: "The UI is weird on my device?",
    answer: "Try refreshing the website. If it still doesn't work, contact us and try it with another device: laptop, computer, or other mobile devices."
  }
];
                  ...
                  {troubleData.map((tst) => (
                    <Link key={tst.id} href={`troubleshooting/${tst.id}/`}>
                      <div className="cursor-pointer p-4 rounded hover:bg-orange-100 transition">
                        <h3 className="text-lg font-semibold text-orange-600">{tst.question}</h3>
                      </div>
                    </Link>
                  ))}
                </div>
