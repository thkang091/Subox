...
import { 
  ...
  Clock, TrendingUp, TrendingDown  // Add these new ones
} from 'lucide-react';
  ...
  return (
    <div className="p-5 border-t border-gray-200 animate-fadeIn">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <h3 className="font-bold mb-3 text-gray-800">Find by Enhanced Commute (Optional)</h3>
...
const renderCommuteInfo = (listing) => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Navigation */}
        <nav className="fixed md:left-0 md:top-0 md:bottom-0 md:h-full md:w-16 w-full top-0 left-0 h-16 bg-orange-200 text-white shadow-lg z-50 md:flex md:flex-col transform transition-all duration-500 ease-out">
          {/* top navigation for mobile */}
          <div className="w-full h-full flex items-center justify-between px-4 md:hidden">
            {/* logo */}
            <span className="font-bold text-lg animate-fadeInLeft">Subox</span>
            
            {/* mobile button group */}
            <div className="flex items-center space-x-4 animate-fadeInRight">
              <button
                title="Add New"
                className="group cursor-pointer outline-none hover:rotate-90 duration-300 p-2 rounded-lg hover:bg-orange-300 transform hover:scale-110 transition-all"
              >
                <svg
                  ...
                  height="24px"
                  viewBox="0 0 24 24"
                  className="stroke-slate-100 fill-none group-hover:fill-orange-500 group-active:stroke-slate-200 group-active:fill-orange-900 group-active:duration-0 duration-300 drop-shadow-sm"
                >
                  <path
              ...
              <button 
                ...
                className="p-2 rounded-lg transition-all cursor-pointer hover:bg-orange-300 transform hover:scale-110 hover:shadow-lg"
              >
                <Heart size={20} className={`transition-all duration-300 ${isSidebarOpen ? 'fill-current text-red-400' : ''}`} />
              </button>
          ...
          <div className="hidden md:flex md:flex-col md:h-full">
            ...
            <div className="flex flex-col items-center animate-slideDown">
              {/* logo */}
              <div className="font-bold text-xl mt-6 mb-4 transform hover:scale-105 transition-all duration-300 cursor-pointer">
                Subox
              </div>
              ...
              <button
                title="Add New"
                className="group cursor-pointer outline-none hover:rotate-90 duration-300 p-3 rounded-lg hover:bg-orange-300 transform hover:scale-110 transition-all hover:shadow-lg"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24px"
            ...
            <div className="mt-auto flex flex-col items-center space-y-4 mb-8 animate-slideUp">
              <button 
                title = "Favorites"
                onClick={() => setIsSidebarOpen(!isSidebarOpen)}
                className="p-3 rounded-lg hover:bg-orange-300 transition-all cursor-pointer transform hover:scale-110 hover:shadow-lg"
              >
                <Heart size={20} className={`transition-all duration-300 ${isSidebarOpen ? 'fill-current text-red-400' : ''}`} />
              </button>
      ...
      {/* Favorites Sidebar */}
      <div className={`fixed md:left-16 left-0 top-0 md:top-0 top-16 h-full md:h-full h-[calc(100%-4rem)] w-72 bg-white shadow-xl z-40 transform transition-all duration-500 ease-out ${isSidebarOpen ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'} overflow-auto backdrop-blur-sm`}>
        <div className="p-4 border-b bg-gradient-to-r from-orange-50 to-orange-100">
          <div className="flex justify-between items-center">
            <h2 className="font-bold text-lg text-orange-500 animate-fadeIn">Favorites</h2>
            <button 
              onClick={() => setIsSidebarOpen(false)}
              className="p-2 rounded-full hover:bg-gray-100 transform hover:scale-110 transition-all hover:rotate-90 duration-300"
            >
              <X size={20} />
            </button>
          </div>
        ...
        <div className="p-4">
          ...
          {favoriteListings.length === 0 ? (
            <div className="text-center py-8 text-gray-500 animate-fadeIn">
              ...
              <p className="animate-slideUp">No favorite listings yet</p>
              <p className="text-sm mt-2 animate-slideUp delay-100">Click the heart icon on listings to save them here</p>
            </div>
          ) : (
            <div className="space-y-4">
              {favoriteListings.map((listing, index) => (
                <div 
                  key={listing.id} 
                  className={`border rounded-lg overflow-hidden hover:shadow-md transition-all cursor-pointer transform hover:scale-105 hover:-translate-y-1 animate-slideUp`}
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className="flex">
                    <div 
                      className="w-20 h-20 bg-gray-200 flex-shrink-0 transition-all duration-300 hover:scale-110" 
                      style={{backgroundImage: `url(${listing.image})`, backgroundSize: 'cover', backgroundPosition: 'center'}}
                    ></div>
                    <div className="p-3 flex-1">
                      <div className="font-medium text-gray-700 hover:text-orange-600 transition-colors">{listing.title}</div>
                      <div className="text-sm text-gray-500">{listing.location}</div>
                      <div className="text-sm font-bold text-orange-600 mt-1 animate-pulse">
                        ${convertPrice(listing.price, priceType)}{getPriceUnit(priceType)}
                      </div>
                    </div>
                    <button 
                      className="p-2 text-gray-400 hover:text-red-500 self-start transform hover:scale-125 hover:rotate-12 transition-all"
                      onClick={() => toggleFavorite(listing)}
                    >
                      <X size={16} />
                    </button>
        ...
        <div className="md:pl-16 pt-16 md:pt-0">
          ...
          <div className="relative bg-gradient-to-br from-orange-50 to-white overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-20 text-center">
              ...
              {/* Logo Section */}
              <div className="flex justify-center items-center mb-8 animate-fadeInUp">
          ...
          <div className="w-full max-w-5xl mx-auto px-4 -mt-10 relative z-10 animate-slideUp">
            ...
            {/* Enhanced Saved Searches Section */}
            <div className="mt-6 max-w-5xl mx-auto px-4 animate-slideUp">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-3 animate-fadeInLeft">
                      ...
                      <div>
                        ...
                        <p className="text-orange-100 text-sm">Quick access to your favorite search criteria</p>
                      </div>
                    </div>
                    
                    {/* Enhanced Save Search Button */}
                    <button 
                      className={`flex items-center px-4 py-2.5 rounded-lg transition-all font-medium transform hover:scale-105 ${
                        hasSearchCriteria() 
                          ? 'bg-white text-orange-600 hover:bg-orange-50 shadow-md hover:shadow-lg animate-fadeInRight' 
                          : 'bg-white/20 text-white/60 cursor-not-allowed'
                      }`}
                      onClick={saveSearch}
                      disabled={!hasSearchCriteria()}
                    >
                      <Star size={18} className={`mr-2 ${hasSearchCriteria() ? 'animate-pulse' : ''}`} />
                ...
                <div className="p-6">
                  {savedSearches.length === 0 ? (
                    ...
                    <div className="text-center py-12 animate-fadeIn">
                      <div className="bg-gradient-to-br from-orange-50 to-orange-100 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 animate-bounce-subtle">
                        <Search size={32} className="text-orange-500 animate-pulse" />
                      </div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2 animate-slideUp">No saved searches yet</h3>
                      <p className="text-gray-600 mb-4 max-w-md mx-auto animate-slideUp delay-100">
                        Create a search with your preferred filters and save it for quick access later
                      </p>
                      <div className="flex items-center justify-center gap-4 text-sm text-gray-500 animate-slideUp delay-200">
                        <div className="flex items-center gap-1 transform hover:scale-105 transition-all">
                          <MapPin size={16} className="text-orange-500 animate-pulse" />
                          <span>Set location</span>
                        </div>
                        <div className="w-1 h-1 bg-gray-300 rounded-full animate-ping"></div>
                        <div className="flex items-center gap-1 transform hover:scale-105 transition-all">
                          <Calendar size={16} className="text-orange-500 animate-pulse" />
                          <span>Pick dates</span>
                        </div>
                        <div className="w-1 h-1 bg-gray-300 rounded-full animate-ping"></div>
                        <div className="flex items-center gap-1 transform hover:scale-105 transition-all">
                          <Filter size={16} className="text-orange-500 animate-pulse" />
                          <span>Apply filters</span>
                        </div>
                      </div>
                    </div>
                  ) : (
                    // Saved Searches Grid - Enhanced
                    <>
                      <div className="flex justify-between items-center mb-6 animate-fadeIn">
                        <div className="flex items-center gap-2">
                          <h3 className="font-semibold text-gray-800">Your Saved Searches</h3>
                          <span className="bg-orange-100 text-orange-700 px-2 py-1 rounded-full text-xs font-medium animate-bounce-subtle">
                            {savedSearches.length}
                          </span>
                        </div>
                        <button 
                          className="text-gray-500 hover:text-red-500 text-sm flex items-center gap-1 transition-all transform hover:scale-105"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {savedSearches.map((search, index) => (
                          <div 
                            key={search.id}
                            className={`group bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 hover:shadow-lg transition-all duration-300 border border-gray-200 hover:border-orange-300 relative overflow-hidden transform hover:scale-105 hover:-translate-y-1 animate-slideUp`}
                            style={{ animationDelay: `${index * 100}ms` }}
                          >
                            {/* Background Pattern */}
                            ...
                            {/* Delete Button */}
                            <button 
                              className="absolute top-3 right-3 p-1.5 rounded-full bg-white shadow-sm opacity-0 group-hover:opacity-100 transition-all hover:bg-red-50 hover:text-red-600 transform hover:scale-110 hover:rotate-90 duration-300"
                              onClick={(e) => {
                                e.stopPropagation();
                            ...
                            <div className="relative z-10">
                              ...
                              <div className="mb-3">
                                <div className="flex items-center gap-2 mb-1">
                                  <Calendar size={16} className="text-orange-500 animate-pulse" />
                                  <span className="text-xs font-medium text-gray-600 uppercase tracking-wide">Dates</span>
                                </div>
                                  ...
                                  {search.dateRange.checkIn ? (
                                    <div className="flex items-center gap-1">
                                      ...
                                      {search.dateRange.checkOut && (
                                        <>
                                          <ChevronRight size={12} className="text-gray-400 animate-pulse" />
                              ...
                              <div className="mb-4">
                                <div className="flex items-center gap-2 mb-1">
                                  <BedDouble size={16} className="text-orange-500 animate-pulse" />
                                  <span className="text-xs font-medium text-gray-600 uppercase tracking-wide">Requirements</span>
                                </div>
                                <div className="flex items-center gap-3 text-sm text-gray-700">
                                  <div className="flex items-center gap-1">
                                    <span className="font-medium">{search.bedrooms}</span>
                                    <span>bed{search.bedrooms !== 1 ? 's' : ''}</span>
                                  </div>
                                  <div className="w-1 h-1 bg-gray-400 rounded-full animate-ping"></div>
                                  <div className="flex items-center gap-1">
                                    <span className="font-medium">{search.bathrooms}</span>
                                    <span>bath{search.bathrooms !== 1 ? 's' : ''}</span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <button 
                                ...
                                className="w-full py-2.5 bg-white border border-orange-200 text-orange-600 rounded-lg hover:bg-orange-50 hover:border-orange-300 transition-all font-medium flex items-center justify-center gap-2 group-hover:shadow-md transform hover:scale-105"
                              >
