  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      {showConversationList && (
        <div className={`w-53 md:w-85 bg-white border-r border-gray-200 flex flex-col transition-all duration-300 overflow-y-auto`}>
          {/* Header */}
          <div className="p-4 border-b border-gray-200">
            ...
            {/* Tab Selection */}
            <div className="flex space-x-1 mb-4 text-[8px] md:text-sm bg-gray-100 rounded-lg p-1">
              <button
                onClick={() => setActiveTab('all')}
                className={`flex-1 px-3 py-2 rounded-md transition-colors font-medium ${
              ...
              <button
                ...
                className={`flex-1 px-3 py-2 rounded-md transition-colors flex items-center justify-center font-medium ${
                ...
                {filteredConversations.map((conv) => (
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      {/* Listing Image */}
                      <div className="w-12 h-12 rounded-lg flex-shrink-0 relative">
                        <img 
      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <button
              onClick={() => isMoveOutSale ? router.push('/sale/browse') : router.push('/sublease/search/')}
                ...
                {group.messages.map((message, messageIndex) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {!isOwnMessage && (
                        <div className={`w-8 h-8 rounded-full mr-2 flex-shrink-0 ${showAvatar ? '' : 'invisible'}`}>
                          {getSafeImageUrl(conversation.otherParticipant.image, 'user') ? (
                            <img 
                              src={getSafeImageUrl(conversation.otherParticipant.image, 'user')}
                              alt={conversation.otherParticipant.name}
      ...
      {showListingDetails && listing && (
        <div className="w-53 md:w-85 bg-white border-l border-gray-200 overflow-y-auto flex-shrink-0">
          {/* Header */}
          <div className="p-4 border-b border-gray-200">
            <div className="flex items-center justify-between mb-4">
