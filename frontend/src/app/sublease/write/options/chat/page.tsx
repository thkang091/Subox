  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="bg-white shadow-sm border-b sticky top-0 z-50 backdrop-blur-sm bg-white/95">
        <div className="w-full flex items-center justify-between px-4 py-2 bg-white shadow hidden md:flex">
          <motion.div 
        ...
        <div className="w-full flex items-center justify-between px-4 py-2 bg-white shadow flex md:hidden">
          <motion.div 
              className="flex items-center space-x-5"
              whileHover={{ scale: 1.05 }}
              onClick={() => router.push("/find")}
