                          ...
                          {product.veteran && (
                            <div className="w-5 h-5">
                              ...
                              >
                                ...
                                <circle cx="50" cy="50" r="48" fill="#c4b89e" />

                                {/* Camouflage blobs */}
                                <path fill="#7a744f" d="M15 40 Q30 25 45 45 T65 40 Q80 50 70 65 T50 70 Q35 65 25 55 Z" />
                                <path fill="#4a3a26" d="M60 25 Q70 30 75 50 Q80 60 70 65 Q60 70 55 50 Z" />
                                <path fill="#5b6542" d="M35 65 Q45 75 50 80 Q55 70 40 65 Z" />
                                <path fill="#383832" d="M20 60 Q25 70 30 75 Q20 80 15 75 Z" />
                                <path fill="#d7d1c1" d="M45 40 Q50 45 55 50 Q50 55 45 50 Z" />
