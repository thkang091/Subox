    ...
    <div className="bg-white/90 backdrop-blur-sm border-b border-gray-100 sticky top-0 z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.button 
          ...
          className="flex items-center px-4 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 transition-colors absolute top-5 right-5"
        >
          <ArrowLeft className="mr-2 text-gray-500" />
